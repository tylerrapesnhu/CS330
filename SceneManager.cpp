...
void SceneManager::LoadSceneTextures()
{
	...
	bReturn = CreateGLTexture(
		"textures/plaster.jpg", "plaster");

	bReturn = CreateGLTexture(
		"textures/Sky.jpg", "sky");

	bReturn = CreateGLTexture(
		"textures/ocean.jpg", "ocean");
	
	bReturn = CreateGLTexture(
		"textures/railing.jpg", "railing");

	bReturn = CreateGLTexture(
		"textures/window.jpg", "window");

	bReturn = CreateGLTexture(
		"textures/stone.jpg", "stone");

	bReturn = CreateGLTexture(
		"textures/cobblestone.jpg", "cobblestone");
...
void SceneManager::DefineObjectMaterials()
{
	...
	skyMaterial.diffuseColor = glm::vec3(0.4f, 0.5f, 0.7f);
	skyMaterial.specularColor = glm::vec3(0.1f, 0.1f, 0.1f);
	skyMaterial.shininess = 5.0f;
	skyMaterial.tag = "skybackground";
...
void SceneManager::SetupSceneLights()
{
	...
	m_pShaderManager->setVec3Value("lightSources[2].position", -10.0f, 0.0f, 0.0f);
	...
	m_pShaderManager->setVec3Value("lightSources[3].position", -10.0f, 0.0f, 0.0f);
...
void SceneManager::RenderScene()
{
	...
	SetTextureUVScale(1.0, 1.0);
	SetShaderMaterial("skybackground");
...
// set the XYZ scale for the mesh
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(0.0f, 6.8f, 0.0f);
...
// set the XYZ scale for the mesh
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(0.0f, 8.3f, 0.0f);
